...
import com.example.android2project.activities.LoggedInActivity;
    ...
    public View onCreateView(@androidx.annotation.NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((LoggedInActivity)getActivity()).navigationNew();
                ((LoggedInActivity)getActivity()).enableTabLayout();
                getActivity().getSupportFragmentManager().beginTransaction().remove(MyProfileFragment.this).commit();
